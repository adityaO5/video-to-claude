...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (l.u_time) g.uniform1f(l.u_time, t)
      if (l.u_resolution) g.uniform2f(l.u_resolution, width, height)
      if (l.u_colorBack) g.uniform4fv(l.u_colorBack, hexToRgba(colorBack))
      if (l.u_colorFront) g.uniform4fv(l.u_colorFront, hexToRgba(colorFront))
      if (l.u_shape) g.uniform1f(l.u_shape, DitheringShapes[shape])
      if (l.u_type) g.uniform1f(l.u_type, DitheringTypes[type])
      if (l.u_pxSize) g.uniform1f(l.u_pxSize, pxSize)
